    ...
    return (
        <View style={styles.container}>
            <View style={{ width: "25%" }}>
                ...
                <InputCombo title="Mật khẩu:" handleValueChange={setPassword} isPassword="true" />
                <InputCombo title="Xác nhận mật khẩu:" handleValueChange={setConfirmPassword} isPassword="true" />
