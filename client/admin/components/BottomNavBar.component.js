...
export default function BottomNavBar(props) {
    return (
        <Tab.Navigator screenOptions={{
            ...
            <Tab.Screen name="AccInfo" component={AccInfoScreen} options={{ tabBarLabel: "Tài khoản", tabBarIcon: ({ size, color }) => (<Icon name="user" color={color} size={size} />), headerShown: false }} />
            <Tab.Screen name="Setting" component={SettingScreen} options={{ tabBarLabel: "Cài đặt", tabBarIcon: ({ size, color }) => (<Icon name="gear" color={color} size={size} />), headerShown: false }} />
        </Tab.Navigator>
    );
}