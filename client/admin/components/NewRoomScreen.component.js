...
export default function NewRoomScreen({ navigation }) {
    ...
    return (
        <View style={styles.container}>
            ...
            <DropDownPicker containerStyle={styles.picker} open={typeOpen} value={typeValue} items={typeItems} setOpen={setTypeOpen} setValue={setTypeValue} setItems={setTypeItems} placeholder="Loại phòng" onOpen={onTypeOpen} zIndex={3000} zIndexInverse={1000} min={1} />
            <DropDownPicker containerStyle={styles.picker} open={extraOpen} value={extraValue} items={extraItems} setOpen={setExtraOpen} setValue={setExtraValue} setItems={setExtraItems} placeholder="Tiện ích" multiple={true} onOpen={onExtraOpen} zIndex={2000} zIndexInverse={2000} />
